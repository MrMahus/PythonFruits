    ...
    def setTable(self, pOrder, pStock):
        ...
        while cursor < stockLength:
            ...
            if list(pStock.keys())[cursor] == pOrder[0]:
                ...
                cell = "                                                      \n|" + "{0}".format(
                    list(pStock.keys())[cursor]).center(16, " ") + "|" + "{0}".format(
                    list(pStock.values())[cursor]).center(18, " ") + "|" + "-{0}".format(pOrder[1]).center(17,
                                                                                                           " ") + "|\n|----------------|------------------|-----------------|"
            else:
                cell = "                                                      \n|" + "{0}".format(
                    list(pStock.keys())[cursor]).center(16, " ") + "|" + "{0}".format(
                    list(pStock.values())[cursor]).center(18, " ") + "|" + "".center(17,
                                                                                     " ") + "|\n|----------------|------------------|-----------------|"
